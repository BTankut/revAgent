import type { GatewayExecutorBinding, GatewayPolicyClass } from "./registry.js";
...
export const E5_TOOL_BINDINGS: readonly ToolBindingRow[] = Object.freeze([
  ...
  { tool: "get_revit_mcp_status", target: "core.session.status", module: "runtime", policyClass: "auto", executor: "bridge" },
  { tool: "send_code_to_revit", target: "core.code.execute", module: "runtime", policyClass: "confirm", executor: "bridge" },
  { tool: "send_code_to_revit_safe", target: "core.code.preview", module: "runtime", policyClass: "auto", executor: "bridge" },
  { tool: "get_revit_session_context", target: "core.document.context", module: "runtime", policyClass: "auto", executor: "bridge" },
  { tool: "get_active_view_context", target: "core.view.context", module: "runtime", policyClass: "auto", executor: "bridge" },
  { tool: "list_open_views", target: "core.view.list_open", module: "runtime", policyClass: "auto", executor: "bridge" },
  { tool: "activate_view", target: "core.view.activate", module: "runtime", policyClass: "auto", executor: "bridge" },
  { tool: "close_view", target: "core.view.close", module: "runtime", policyClass: "auto", executor: "bridge" },
  { tool: "clear_selection", target: "core.ui.clear_selection", module: "runtime", policyClass: "auto", executor: "bridge" },
  { tool: "delete_review_view", target: "core.view.delete_review", module: "runtime", policyClass: "confirm", executor: "bridge" },
  { tool: "get_ui_state", target: "core.ui.state", module: "runtime", policyClass: "auto", executor: "bridge" },
  { tool: "find_elements", target: "core.element.query", module: "runtime", policyClass: "auto", executor: "bridge" },
  { tool: "open_existing_plan_for_element_level", target: "core.view.open_plan_for_level", module: "runtime", policyClass: "auto", executor: "bridge" },
  { tool: "focus_elements", target: "core.view.focus", module: "runtime", policyClass: "auto", executor: "bridge" },
  { tool: "section_box_elements", target: "core.view.section_box", module: "runtime", policyClass: "auto", executor: "bridge" },
  { tool: "create_3d_view_for_elements", target: "core.view.create_3d", module: "runtime", policyClass: "auto", executor: "bridge" },
  { tool: "export_revit_view_image", target: "core.image.export_view", module: "runtime", policyClass: "auto", executor: "bridge" },
  { tool: "export_revit_coordination_image", target: "core.image.export_coordination", module: "runtime", policyClass: "auto", executor: "bridge" },
  { tool: "show_element_in_plan_and_3d", target: "core.view.show_plan_3d", module: "runtime", policyClass: "auto", executor: "bridge" },
  { tool: "smart_focus_elements", target: "core.view.smart_focus", module: "runtime", policyClass: "auto", executor: "bridge" },
  { tool: "inspect_elements", target: "core.element.inspect", module: "runtime", policyClass: "auto", executor: "bridge" },
  { tool: "inspect_levels", target: "core.level.inspect", module: "runtime", policyClass: "auto", executor: "bridge" },
  { tool: "inspect_sheet_text", target: "core.sheet.inspect_text", module: "runtime", policyClass: "auto", executor: "bridge" },
  { tool: "inspect_schedules", target: "core.schedule.inspect", module: "runtime", policyClass: "auto", executor: "bridge" },
  // E5 assigns schedule reconciliation to the Gateway runtime: it works against
  // supplied spreadsheet data, not against Revit.
  { tool: "reconcile_schedule_excel", target: "core.schedule.reconcile_excel", module: "runtime", policyClass: "auto", executor: "internal_mcp" },
  { tool: "count_annotations", target: "core.annotation.count", module: "runtime", policyClass: "auto", executor: "bridge" },
  { tool: "inspect_parameter_schema", target: "core.parameter.inspect_schema", module: "runtime", policyClass: "auto", executor: "bridge" },
  { tool: "set_element_parameter", target: "core.parameter.set", module: "runtime", policyClass: "confirm", executor: "bridge" },
  { tool: "set_schedule_cells", target: "core.schedule.set_cells", module: "runtime", policyClass: "confirm", executor: "bridge" },
  { tool: "set_schedule_cells_by_text", target: "core.schedule.set_cells_by_text", module: "runtime", policyClass: "confirm", executor: "bridge" },
  { tool: "capture_spatial_snapshot", target: "core.spatial.capture", module: "runtime", policyClass: "auto", executor: "bridge", hybrid: true },
  { tool: "query_spatial_context", target: "core.spatial.query", module: "runtime", policyClass: "auto", executor: "internal_mcp" },
  { tool: "compare_spatial_snapshots", target: "core.spatial.compare", module: "runtime", policyClass: "auto", executor: "internal_mcp" },
  { tool: "summarize_spatial_state", target: "core.spatial.summarize", module: "runtime", policyClass: "auto", executor: "internal_mcp" },
  { tool: "search_api", target: "core.docs.search", module: "docs", policyClass: "auto", executor: "internal_mcp" },
  { tool: "get_type_details", target: "core.docs.type", module: "docs", policyClass: "auto", executor: "internal_mcp" },
  { tool: "get_member_details", target: "core.docs.member", module: "docs", policyClass: "auto", executor: "internal_mcp" },
  { tool: "list_namespace", target: "core.docs.namespace", module: "docs", policyClass: "auto", executor: "internal_mcp" },
  { tool: "resolve_api_symbols_bulk", target: "core.docs.resolve_bulk", module: "docs", policyClass: "auto", executor: "internal_mcp" },
] as const);
...
export function verifyToolBindings(
  ...
  for (const row of rows) {
    ...
    if (targets.has(row.target)) {
      fail("target_duplicate", `${row.target} is assigned to more than one tool`);
    }
