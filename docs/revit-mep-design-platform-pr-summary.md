...
- `productionReadiness` now returns `nextRequiredInputs`, pointing to office-standards, project-critical-data, or proposal-validation handoff artefacts needed to clear current blockers.
