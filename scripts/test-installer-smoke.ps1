...
try {
    ...
    Assert-True ($countAnnotationsToolCode -match 'placed_schedule_cells' -and $countAnnotationsToolCode -match 'maxScheduleCellsScanned') "count_annotations must expose placed schedule-cell source and cell scan caps."
    ...
    Assert-True ($countAnnotationsHandlerCode -match 'ScanPlacedScheduleCells' -and $countAnnotationsHandlerCode -match 'BuildPlacedScheduleCellEvidenceRow' -and $countAnnotationsHandlerCode -match 'Stop\("max_cells"\)') "count_annotations native handler must scan placed schedule cells with shared evidence helpers and canonical cell caps."
