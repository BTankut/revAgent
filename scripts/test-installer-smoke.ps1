...
try {
    ...
    Assert-True ($showPlan3dToolCode -match 'function readField') "show_element_in_plan_and_3d must read normalized bridge result fields case-insensitively."
    ...
    Assert-True ($openPlanToolCode -match 'function readField') "open_existing_plan_for_element_level must read normalized bridge result fields case-insensitively."
