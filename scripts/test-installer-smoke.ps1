...
try {
    ...
    Assert-True ($coordinationImageToolCode -match 'surfaceTransparency = String\.Equals\(targetVisualStyle, \"qa_high_contrast\"') "Coordination image export must use softer surface transparency outside QA high-contrast style."
