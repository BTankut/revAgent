...
try {
    ...
    Assert-True ($installTaskText -match 'preserved previously pinned local trusted release keys' -and $installTaskText -match 'Trusted release keys were previously pinned') "Updater installer repair must warn or preserve keys when NAS trusted release keys are missing."
