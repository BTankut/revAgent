...
'@
    ...
    Assert-True ($bootstrapRefreshText -match 'Administrator session detected' -and $bootstrapRefreshText -match 'Invoke-AuthenticatedBootstrapApply' -and $bootstrapRefreshText -notmatch 'Start this refresh normally, not as administrator') "Bootstrap refresh must support clean/stale installs when the STABLE launcher is started from an already-elevated shell."
