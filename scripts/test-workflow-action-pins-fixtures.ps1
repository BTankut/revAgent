...
$fixtures = @(
    ...
    [pscustomobject]@{ name = 'block-blank-comment-first-payload'; success = $false; content = "description: |`n`n  # ignored before inferred content indent`n    payload`n  uses: actions/checkout@v6`n" },
