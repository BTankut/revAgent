...
"@
    ...
    Assert-True ($workflowText -match 'actions/upload-artifact@[0-9a-f]{40}\s+# actions/upload-artifact@v7' -and $workflowText -match 'actions/download-artifact@[0-9a-f]{40}\s+# actions/download-artifact@v8' -and $workflowText -match 'artifact-ids:') "CD workflow should transfer only the exact uploaded artifact id into the publish job."
