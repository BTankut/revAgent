...
import { isRuntimeReportPlan, verifyRuntimeReportPlan } from "../write-plan/runtimeReportExecutor.js";
...
export function registerVerifyWritePlanTool(server) {
    server.tool("verify_write_plan", "Verify a committed or proposed write-plan by re-reading model state through the native executor, or report files through the runtime report executor. This mode is read-only.", {
