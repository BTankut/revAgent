...
- Documented the merged MEP production package surface in README, skill,
  workstation agent guidance, platform docs, and `docs/MEP_PRODUCTION_PACKAGES.md`,
  including the distinction between runtime MCP tools and Revit add-in/ribbon
  commands.
