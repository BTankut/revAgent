...
export function buildSpatialQueryFingerprint(value) {
    return sha256Canonical(value);
}
export function encodeSpatialQueryCursor(envelope) {
    const normalized = {
...
export function decodeSpatialQueryCursor(cursor, expected) {
