export const RECONCILIATION_REQUIRED_ROLES = ["identity", "comparisonText"];
...
export function cleanReconciliationText(value) {
    return String(value ?? "").replace(/\s+/g, " ").trim();
}
export function normalizeReconciliationHeader(value) {
...
export function normalizeReconciliationAlias(value) {
...
export function tokenizeReconciliationText(value) {
...
function canonicalizeCompoundUnits(text) {
    return text
...
function parseCompactDimension(value) {
