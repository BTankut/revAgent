import { z } from "zod";
import { buildBroadScanFailureResult, buildBroadScanGuardedResult, } from "../utils/broadScanResult.js";
import { formatJsonContent } from "../utils/revitToolHelpers.js";
import { excelIngestionSourceSchema, ingestExcelSource, } from "./reconcile_excel_ingestion.js";
import { adaptScheduleSource, scheduleAdapterSourceSchema, } from "./reconcile_schedule_adapter.js";
import { reconcileScheduleExcelRecords, reconciliationConfigSchema, } from "./reconcile_matching.js";
...
function failedStageResult(stage, error, extra = {}) {
    const { warnings = [], notices = [], scanPolicy = {}, summary = {}, suggestedNextScopes = [], ...rest } = extra;
...
function firstNonCompletedStopReason(...results) {
