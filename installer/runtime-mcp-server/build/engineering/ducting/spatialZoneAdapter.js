import { aabbFromValue, asNumber, asRecord, pointFromValue, round, stringByFields, valueByFields, } from "./helpers.js";
function readObstacleSummary(raw, index) {
...
function readShaftSummary(raw, index) {
...
function readPlenumSummary(raw, index) {
    return {
...
function uniqueSortedRounded(values, fractionDigits = 1) {
    const seen = new Set();
    const result = [];
...
export function mapSpatialZoneToRoutingContext(input) {
