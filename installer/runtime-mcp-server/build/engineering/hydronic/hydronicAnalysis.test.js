...
import { analyzeHydronicPipingGraph, calculateDarcyWeisbachPressureDropPa, calculateHazenWilliamsPressureDropPa, calculateVelocityMps, equivalentLengthFromK, } from "./hydronicAnalysis.js";
...
assert(reversed.warnings.some((warning) => warning.includes("Possible reversed graph direction")));
