...
var requestedElementIds = ${Ol(n.ids)};
double marginFeet = ${R} / 304.8;
...
double effectiveMarginMm = targetElements.Count == 1 ? Math.Min(${R}, ${P}) : ${R};
...
string requestedSection = ${T(p)};
string[] rowTextQueries = ${Se(r)};
string rowMatchMode = ${T(f)};
