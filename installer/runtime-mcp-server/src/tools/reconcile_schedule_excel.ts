...
function compactCandidateRows(row: JsonObject, limit: number): JsonObject {
...
function compactReconciliationResult(result: JsonObject, args: JsonObject): JsonObject {
