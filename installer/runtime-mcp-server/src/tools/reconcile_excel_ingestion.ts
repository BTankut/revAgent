...
function readExcelCell(cell: ExcelJS.Cell, sheetName: string): TableCell {
...
function selectWorksheet(workbook: ExcelJS.Workbook, selection: z.infer<typeof excelSelectionSchema>, nonEmptySheets: ExcelJS.Worksheet[]): ExcelJS.Worksheet | null {
...
function readWorksheetTable(worksheet: ExcelJS.Worksheet, selection: z.infer<typeof excelSelectionSchema>, budgets: ExcelIngestionBudgets, startedAt: number): TableData {
...
function findWorksheetBounds(worksheet: ExcelJS.Worksheet) {
