...
function semanticCanonicalJson(value: any): string {
    if (value === null) {
        return "null";
    }
...
function sha256SemanticCanonical(value: any) {
...
function semanticErrors(payload: JsonObject) {
    const errors: string[] = [];
...
function workContinuationSemanticErrors(payload: JsonObject) {
    const errors: string[] = [];
...
export function validateSpatialExtractionPageContract(payload: unknown) {
