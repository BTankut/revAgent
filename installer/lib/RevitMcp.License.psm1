...
$distributionIntegrityModule = Join-Path $PSScriptRoot "RevitMcp.DistributionIntegrity.psm1"
if (-not (Test-Path -LiteralPath $distributionIntegrityModule -PathType Leaf)) {
    throw "Distribution integrity helper module was not found beside RevitMcp.License.psm1."
}
