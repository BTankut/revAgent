...
.DESCRIPTION
    ...
    locations (Codex CLI, Claude Code), determines whether each one is a
...
$candidates = @(
    @{ Host = "Codex CLI";   Path = Join-Path $env:USERPROFILE ".codex\skills\revit-mcp" },
...
Write-Host "  - Codex CLI   : /skills reload"
